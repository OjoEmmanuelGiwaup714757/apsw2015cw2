...
public class MilestoneController {
    ...
    public String dosubmitMilestone() throws IOException{ 
            ...
            R = (Registation) sessionMap.get("Allregist");
            uploadfile();
    ...
    public List<Milestones> getMilestoneByID() {
            Map<String, Object> sessionMap = externalContext.getSessionMap();
            stuid = (Long) sessionMap.get("studentidtemp");
            return ms.findAllMilestoneBymtid(mt.getId(), stuid);
    }
    ...
    public String uploadfile() throws IOException {
        ...
        this.myFilePath = "/Users/Gooloo/GlassFish_Server/glassfish/domains/domain1/generated/jsp/apsw2015cw2/" + getFileName(file);
